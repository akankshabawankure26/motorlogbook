...
import img2 from '../asset/rwtlogo.png';
        ...
        <div>
            <div className="position-relative bg-light d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="position-absolute top-0 w-100 d-flex justify-content-between align-items-center px-4 py-3">
                    ...
                    <a href="https://www.nexuxrise.com/" className="d-flex justify-content-center">
                        <img src={img2} alt="Business Platform" className="img-fluid rounded" style={{ height: '200px', width: '250px' }} /> {/* Adjusted size */}
                    </a>
